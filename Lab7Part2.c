    ...
    */
    ...
    if (cpu == 'B') {
        ...
        while (userMove == true && bothNoMoves != 2 && checkFullBoard(board, dimension) == false) {
            ...
            double time_start = start.tv_sec + start.tv_usec/1000000.0; 
            //place code here
                                ...
                                for (int deltaRow = -1; deltaRow < 2; deltaRow++) {
                                    for (int deltaCol = -1; deltaCol < 2; deltaCol++) {
                                        if (checkLegalInDirection(board, dimension, vrow, vcol, 'B', deltaRow, deltaCol) == true && scoreInDirection(board, dimension, vrow, vcol, cpu, deltaRow, deltaCol) > 0) {
                                            ...
                                            else if (vrow - 'a' == 0 && vcol - 'a' == dimension - 1) {
                                                maxScore = *tScore;
                                                minRow = *tRow - 'a';
                                                minCol = *tCol - 'a';
                                                tminRow = minRow;
                                            ...
                                            else if (vrow - 'a' == dimension - 1 && vcol - 'a' == 0) {
                                                maxScore = *tScore;
                                                minRow = *tRow - 'a';
                                                minCol = *tCol - 'a';
                                                tminRow = minRow;
                                            ...
                                            else if (vrow - 'a' == dimension -1 && vcol - 'a' == dimension - 1) {
                                                maxScore = *tScore;
                                                minRow = *tRow - 'a';
                                                minCol = *tCol - 'a';
                                                tminRow = minRow;
                                            ...
                                            else if (vrow - 'a' == 0 || vrow - 'a' == dimension - 1) {
                                                maxScore = *tScore;
                                                minRow = *tRow - 'a';
                                                minCol = *tCol - 'a';
                                                tminRow = minRow;
                                            ...
                                            else if (vcol - 'a' == 0 || vcol - 'a' == dimension - 1) {
                                                maxScore = *tScore;
                                                minRow = *tRow - 'a';
                                                minCol = *tCol - 'a';
                                                tminRow = minRow;
